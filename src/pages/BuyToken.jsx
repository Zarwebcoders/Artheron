                            ...
                            >
                                ...
                                <div className="relative z-10 space-y-10">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="relative group">
                                            <div className="bg-[#050814]/50 border-2 border-dashed border-white/5 rounded-3xl p-10 flex flex-col items-center justify-center gap-4 group-hover:border-[#22d3ee]/30 transition-all cursor-pointer">
                                                <div className="w-12 h-12 rounded-full bg-[#22d3ee]/10 flex items-center justify-center text-[#22d3ee]">
                                                    <Upload size={24} />
                                                </div>
                                                <div className="text-center">
                                                    <p className="text-xs text-white font-bold uppercase tracking-widest">Upload Screenshot</p>
                                                    <p className="text-[10px] text-gray-600 mt-1 uppercase">JPG, PNG, PDF up to 5MB</p>
                                                </div>
                                            </div>
                                        ...
                                        <button 
                                            ...
                                            className="w-full py-6 rounded-3xl bg-gradient-to-r from-green-500 to-[#22d3ee] text-white font-bold uppercase tracking-widest text-[10px] shadow-[0_0_30px_rgba(34,197,94,0.3)] transition-all hover:scale-[1.01] active:scale-95 flex items-center justify-center gap-3 group"
                                        >
